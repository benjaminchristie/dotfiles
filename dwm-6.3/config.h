...
static const unsigned int gappih    = 12;       /* 32, horiz inner gap between windows */
static const unsigned int gappiv    = 6;       /* 25, vert inner gap between windows */
static const unsigned int gappoh    = 8;       /* 25, horiz outer gap between windows and screen edge */
static const unsigned int gappov    = 6;       /* 20,  vert outer gap between windows and screen edge */
static       int smartgaps          = 1;        /* 1 means no outer gap when there is only one window */
static const int showbar            = 1;        /* 0 means no bar */
static const int topbar             = 1;        /* 0 means bottom bar */
static const char *fonts[]          = { "Source Code Pro:size=11:style=Medium" };
static const char dmenufont[]       = "Source Code Pro:size=11:style=Medium";
...
static const char col_mag[]         = "#6666ea";
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_grn, "-sf", col_gray4, NULL };
