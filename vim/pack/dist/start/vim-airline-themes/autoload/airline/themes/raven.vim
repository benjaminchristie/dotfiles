...
let s:N1 = [ '#c8c8c8' , '#1e1e1e' , 188 , 235 ]
let s:N2 = [ '#c8c8c8' , '#1e1e1e' , 188 , 235 ]
let s:N3 = [ '#c8c8c8' , '#1e1e1e' , 188 , 235 ]
...
let g:airline#themes#raven#palette.normal_modified = {
      \ 'airline_c': [ '#e25000' , '#1e1e1e' , 166 , 235 , '' ] ,
      \ }

let s:I1 = [ '#11c279' , '#1e1e1e' , 36 , 235 ]
let s:I2 = [ '#11c279' , '#1e1e1e' , 36 , 235 ]
let s:I3 = [ '#11c279' , '#1e1e1e' , 36 , 235 ]
...
let g:airline#themes#raven#palette.insert_paste = {
      \ 'airline_a': [ s:I1[0]   , '#1e1e1e' , s:I1[2] , 235 , '' ] ,
      \ }
...
let s:V1 = [ '#6565ff' , '#1e1e1e' , 63 , 235 ]
let s:V2 = [ '#6565ff' , '#1e1e1e' , 63 , 235 ]
let s:V3 = [ '#6565ff' , '#1e1e1e' , 63 , 235 ]
...
let g:airline#themes#raven#palette.tabline = {
      \ 'airline_tab':      ['#c8c8c8' , '#1e1e1e' , 188 , 235 , '' ],
      \ 'airline_tabsel':   ['#1e1e1e' , '#a4c639' , 235 , 149 , '' ],
      \ 'airline_tabtype':  ['#c8c8c8' , '#1e1e1e' , 188 , 235 , '' ],
      \ 'airline_tabfill':  ['#c8c8c8' , '#1e1e1e' , 188 , 235 , '' ],
      \ 'airline_tabmod':   ['#1e1e1e' , '#a4c639' , 235 , 149 , '' ],
      \ }

let s:WI = [ '#ff0000', '#1e1e1e', 196, 235 ]
...
let g:airline#themes#raven#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
      \ [ '#c8c8c8' , '#1e1e1e' , 188 , 235 , ''     ] ,
      \ [ '#c8c8c8' , '#1e1e1e' , 188 , 235 , ''     ] ,
      \ [ '#1e1e1e' , '#a4c639' , 235 , 149 , ''     ] )
